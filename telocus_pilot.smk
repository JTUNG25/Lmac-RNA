...
featurecounts = "/QRISdata/Q9141/lmac_rna/sifs/subread.sif"   # TODO: build/pull this container

# ── Pilot scope: change these two lines to pilot a different family/batch ──
PILOT_FAMILY = "Penelope"
PILOT_SAMPLES = BATCH2A_TREATMENT + BATCH2_CONTROL   # Δago1 + its D5-6 control
# ─────────────────────────────────────────────────────────────────────────
